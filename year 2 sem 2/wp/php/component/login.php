<div class="">
    ...
    <?php
        if (isset($_SESSION['DumbNews_loggedinerror'])) {
            echo "<div class='bg-red-500 text-white mb-3 p-3 rounded-md'>" . $_SESSION['DumbNews_loggedinerror'] . "</div>";
            unset($_SESSION['DumbNews_loggedinerror']);
        }
    ?>
