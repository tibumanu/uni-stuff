<?php $title='Article | Dumb News'; include("template/top.php");?>
...
<?php
    ...
    if (mysqli_num_rows($result) > 0) {
        while($row = mysqli_fetch_assoc($result)) {
            ...
            if (isset($_SESSION['DumbNews_loggedin']) && $_SESSION['DumbNews_loggedin'] == true && ($_SESSION['DumbNews_userID'] == $row['Producer'] || $_SESSION['DumbNews_elevation'] == 1)) {
