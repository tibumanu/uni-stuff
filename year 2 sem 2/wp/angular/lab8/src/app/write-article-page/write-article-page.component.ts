...
export class WriteArticlePageComponent {
  ...
  onSubmit() {
    this.http.post('http://localhost/8/backend/add-news.php', {
      title: this.writeArticleForm.value.title,
      category: this.writeArticleForm.value.category,
      contents: this.writeArticleForm.value.contents,
