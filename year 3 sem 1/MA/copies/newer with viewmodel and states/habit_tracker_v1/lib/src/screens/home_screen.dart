...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    final HabitViewModel habitViewModel = Provider.of<HabitViewModel>(context);
    return Scaffold(
      appBar: AppBar(
      ...
      body: Padding(
        ...
        return Card(
          ...
          showModalBottomSheet(
            context: context, 
            builder: (context) => _buildBottomSheet(context, habit, habitViewModel),
      ...
      floatingActionButton: FloatingActionButton(
        focusColor: Color.fromARGB(255, 45, 55, 102),
        backgroundColor: Color.fromARGB(255, 36, 43, 70),
        splashColor: Color.fromARGB(255, 67, 72, 116),
        onPressed: () async {
...
Widget _buildBottomSheet(BuildContext context, Habit habit, HabitViewModel habitViewModel) {
    return Padding(
