...
2.  **Handling Missing Values:**
    ...
    -   Columns with missing values are dropped for simplicity. In a more complex pipeline, imputation strategies could be applied.
...
4.  **Normalization:**
    ...
    -   Features are normalized using StandardScaler to ensure that each feature contributes equally to the model performance.
